    ...
    var jobs: [Job] {
        ...
        return [
            ...
            Job(id: "dupes", title: "Find duplicates",
                blurb: "The same song sitting in your library twice from different releases — so shuffle plays it twice and your counts lie. Gathered into one playlist to clear in a minute.",
                icon: "doc.on.doc", stat: r.duplicates > 0 ? "\(r.duplicates) found" : nil,
